...
def create_interface():
    ...
    class App(ctk.CTk, TkinterDnD.TkinterDnD):
    ...
    # Função para capturar o caminho do arquivo arrastado e solto
    def get_path(event):
        pdf_entry.delete(0, "end")
        pdf_entry.insert(0, event.data)

    # Configuração do suporte a arrastar e soltar
    pdf_entry.drop_target_register(DND_ALL)
    pdf_entry.dnd_bind("<<Drop>>", get_path)
    ...
    log_text.tag_configure("log", font=("